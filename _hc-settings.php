<?php 
	...
	function wphc_settings_output( ){
		...
		<div class="wrap wphc-settings">
			...
			<a target="_blank" class="beer" title="Buy me a beer." href="https://www.paypal.me/richardkeller" style="padding: 1em;position: absolute;top: 0;right: 0;"><img style="width:20px;" src="<?php echo plugin_dir_url( __FILE__ ) . '/assets/images/beercon.png' ?>" alt="Buy me a beer"></a>
